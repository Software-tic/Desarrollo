...
>>>>>>> origin/master
	...
	/**SIAT TUNJA*/
	public List<ReportStudent> loadReportStudentListTunja(Long idZyosGroup, Long ZyosUser, ReportStudent reportSearch) throws Exception {
		ReportStudentDAO dao = new ReportStudentDAO();
		try {
			return dao.loadReportStudentListTunja(idZyosGroup, ZyosUser);
		} catch (Exception e) {
			throw e;
		} finally {
			dao.getSession().close();
