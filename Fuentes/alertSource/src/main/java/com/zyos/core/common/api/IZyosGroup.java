...
>>>>>>> origin/master
	...
	public static final Long TUNJA_TEACHER_COORD_PAAI = Long.valueOf(24);
	
	public static final Long TUNJA_PSYCHOPEDAGOGY = Long.valueOf(28);
	
	public static final Long TUNJA_PAAI = Long.valueOf(29);
	
	public static final Long TUNJA_TEACHER = Long.valueOf(30);
	
	public static final Long TUNJA_PSICOLOGY = Long.valueOf(31);
	
	public static final Long TUNJA_TEACHER_PAAI = Long.valueOf(32);
	
	public static final Long TUNJA_DIVISION_DECAN = Long.valueOf(33);
	
	public static final Long TUNJA_DIVISION_SECRETARY = Long.valueOf(34);
