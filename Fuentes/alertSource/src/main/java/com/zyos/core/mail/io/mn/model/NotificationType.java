...
/**
 * Typenotification entity. @author Óscar Garzón
 */
@Entity
@Table(name = "notificationType")
public class NotificationType extends AZyosModel implements
	...
	/** full constructor */
	public NotificationType(String name, String dateCreation,
