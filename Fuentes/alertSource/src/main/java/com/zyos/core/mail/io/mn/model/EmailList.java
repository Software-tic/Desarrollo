...
public class EmailList extends AParameter implements java.io.Serializable {
	...
	/** minimal constructor */
	public EmailList(String name, String dateCreation, String userCreation,
			Long state) {
		this.name = name;
	...
	/** full constructor */
	public EmailList(String name, String description, String dateCreation,
